...
# `ms` commandline
```
./ms 12 100 -t 10 -I 3 2 2 2 -n 1 0.125 -n 2 0.375 -n 3 0.500 -ej 0.1 1 3 -ej 0.1 2 3
```
...
```
./ms 12 1 -t 100 -I 3 2 2 2 -n 1 0.125 -n 2 0.375 -n 3 0.500 -ej 0.1 1 3 -ej 0.1 2 3
```
